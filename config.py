...
# NOTE: the former SilentGuard integration (NOVA_SILENTGUARD_*) has been
# removed. Any NOVA_SILENTGUARD_* variables still present in an old .env
# are simply ignored — they are never read and never cause an error.
...
# NOTE: the former voice/TTS feature (NOVA_PIPER_*) has been removed.
# Any NOVA_PIPER_* variables still present in an old .env are simply
# ignored — they are never read and never cause an error.
